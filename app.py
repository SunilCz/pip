...
def summarize():
    ...
    summarizer = SummarizeForVisualization(text)
    summary, tf_idf_each_sentence = summarizer.summarize_in_sentence_number(num_sentences)

    return jsonify({'summary': summary, 'tf_idf_each_sentence': tf_idf_each_sentence})
